    ...
    render() {
        return (
            <div id="archive-privacy">
                ...
                <p>
                    Leakey Foundation ("us", "we", or "our") operates the
                    leakeyfoundationarchive.org website (the "Service").
                </p>
                <p>
                ...
                <p>
                    ...
                    accessible from leakeyfoundationarchive.org
                </p>
                ...
                <h2>Use of Data</h2>
                <p>Leakey Foundation uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>
                    Leakey Foundation will take all steps reasonably necessary to ensure that
                ...
                <p>
                    Leakey Foundation may disclose your Personal Data in the good faith belief that
                    such action is necessary to:
                </p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Leakey Foundation</li>
                ...
                <ul><li>By mail: 1003B O'Reilly Ave. San Francisco, CA 94129</li></ul>
            </div>
        );
    }
}
...
export default ArchivePrivacyPolicy;
